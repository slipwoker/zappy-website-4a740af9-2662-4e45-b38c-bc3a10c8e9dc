document.addEventListener('DOMContentLoaded', function() {
    ...
    if (animatedElements.length > 0) {
            ...
            animatedElements.forEach(function(el) {
                if (isElementInViewport(el, 80) && !el.classList.contains('animated')) {
                    ...
                    if (el.hasAttribute('data-animate-delay')) {
                        const delay = parseInt(el.getAttribute('data-animate-delay'));
        ...
        style.textContent = `
            ...
            [data-animate].animated, .fade-in.fade-in-visible, .animate-on-scroll.animated {
                opacity: 1;
        ...
        window.addEventListener('scroll', function() {
            ...
            animationTimeout = requestAnimationFrame(handleScrollAnimation);
        }, { passive: true });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4a740af9-2662-4e45-b38c-bc3a10c8e9dc',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4a740af9-2662-4e45-b38c-bc3a10c8e9dc';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4a740af9-2662-4e45-b38c-bc3a10c8e9dc';
